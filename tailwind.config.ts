...
const config: Config = {
  content: [
    "./pga-nextjs/src/pages/**/*.{js,ts,jsx,tsx,mdx}",
    "./pga-nextjs/src/components/**/*.{js,ts,jsx,tsx,mdx}",
    "./pga-nextjs/src/app/**/*.{js,ts,jsx,tsx,mdx}",
  ],
  theme: {
    extend: {
      colors: {
      ...
      boxShadow: {
        ...
        'toss': '0 2px 12px 0 rgba(0, 0, 0, 0.06)',
      },
      animation: {
